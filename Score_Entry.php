                            ...
                            <?php
							   ...
							   while($row=mysql_fetch_array($fac_name)){
								    if($row['Department_id']==$rs_upd['Department_id'])
										...
										$iselect="";
								?>
                        		<option value="<?php echo $row['Department_id'];?>" <?php echo $iselect ;?> > <?php echo $row['Department_name'];?> </option>
                                <?php 
							   }
                            ?>
                    </select>
...
?>
    ...
    <div id="top_style">
       ...
       <div id="top_style_button"> 
       		<form method="post">
            	<a href="?tag=view_scores"><input type="button" name="btn_view" value="View_Score" id="button_view" style="width:120px;"  /></a>
