...
if(isset($_GET['rs_id']))
	...
	if($opr=="del")
{
	$del_sql=mysql_query("DELETE FROM department_tbl WHERE department_id=$id");
	if($del_sql){
...
<table width="755">
	<tr>
    	<td width="200px" style="font-size:18px; color:#006; text-indent:30px;">View Departments</td>
        <?php
...
<div id="content-input">
	...
	if($key !="")
		$sql_sel=mysql_query("SElECT * FROM department_tbl WHERE department_name  like '%$key%' ");
	else
    		$sql_sel=mysql_query("SELECT * FROM department_tbl");
    ...
    $color=($i%2==0)?"lightblue":"white";
      ...
      <tr bgcolor="<?php echo $color?>">
            ...
            <?php
             ...
             ?>
            <td align="center"><a href="?tag=faculties_entry&opr=upd&rs_id=<?php echo $row['Department_id'];?>" title="Upate"><img src="picture/update.png" /></a></td>
            <td align="center"><a href="?tag=view_faculties&opr=del&rs_id=<?php echo $row['Department_id'];?>" title="Delete"><img src="picture/delete.png" /></a></td>
            <?php } ?>
        </tr>
    <?php	
    }
