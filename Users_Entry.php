    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
            	...
            	<td>
                	...
                	<input type="radio" name="typetxt" value="visitor" 
                	<?php if($rs_upd['type']=="visitor") echo "checked";?> checked/>Visitor
                	<input type="radio" name="typetxt" value ="creator"
                	<?php if($rs_upd['type']=="creator") echo "checked";?>/> Creator
                </td>
            </tr>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
            	<td>Type</td>
            	<td>
            		<input type="radio" name="typetxt" value="visitor" checked/>Visitor
                	<input type="radio" name="typetxt" value ="creator" /> Creator
                </td>
            </tr>
